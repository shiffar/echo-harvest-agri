        ...
        <div class="d-flex align-items-center flex-stack flex-grow-1">
            ...
            <div class="app-header-logo d-flex align-items-center flex-stack px-lg-10 mb-2" id="kt_app_header_logo">
                ...
                <a href="index.html" class="app-sidebar-logo">
                    <img alt="Logo" :src="`${publicPath}admin-assets/media/logos/default.svg`"
                        class="h-30px theme-light-show">
                    <img alt="Logo" :src="`${publicPath}admin-assets/media/logos/default-dark.svg`"
            ...
            <div class="app-navbar flex-grow-1 justify-content-end" id="kt_app_header_navbar">
                                    ...
                                    <div class="scroll-y mh-200px mh-lg-350px">
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <img :src="`${publicPath}admin-assets/media/avatars/300-6.jpg`" alt="">
                                            </div>
                                            <!--end::Symbol-->
                                        ...
                                        <a href="#"
                                            ...
                                            <!--begin::Symbol-->
                                            <div class="symbol symbol-40px me-4">
                                                <img :src="`${publicPath}admin-assets/media/avatars/300-2.jpg`" alt="">
                                            </div>
                                            <!--end::Symbol-->
                                        ...
                                        <a href="#"
                                            ...
                                            <!--begin::Symbol-->
                                            <div class="symbol symbol-40px me-4">
                                                <img :src="`${publicPath}admin-assets/media/avatars/300-9.jpg`" alt="">
                                            </div>
                                            <!--end::Symbol-->
                                        ...
                                        <a href="#"
                                            ...
                                            <!--begin::Symbol-->
                                            <div class="symbol symbol-40px me-4">
                                                <img :src="`${publicPath}admin-assets/media/avatars/300-14.jpg`" alt="">
                                            </div>
                                            <!--end::Symbol-->
                                        ...
                                        <a href="#"
                                            ...
                                            <!--begin::Symbol-->
                                            <div class="symbol symbol-40px me-4">
                                                <img :src="`${publicPath}admin-assets/media/avatars/300-11.jpg`" alt="">
                                            </div>
                                            <!--end::Symbol-->
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px"
                                                        :src="`${publicPath}admin-assets/media/svg/brand-logos/volicity-9.svg`"
                                                        alt="">
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px"
                                                        :src="`${publicPath}admin-assets/media/svg/brand-logos/tvit.svg`"
                                                        alt="">
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px"
                                                        :src="`${publicPath}admin-assets/media/svg/misc/infography.svg`"
                                                        alt="">
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px"
                                                        :src="`${publicPath}admin-assets/media/svg/brand-logos/leaf.svg`"
                                                        alt="">
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px"
                                                        :src="`${publicPath}admin-assets/media/svg/brand-logos/tower.svg`"
                                                        alt="">
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                ...
                <div class="app-navbar-item ms-3 ms-lg-4 me-lg-2" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-30px symbol-lg-40px"
                        ...
                        <img :src="`${publicPath}admin-assets/media/avatars/300-2.jpg`" alt="user">
                    </div>
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <img :src="`${publicPath}admin-assets/media/avatars/300-2.jpg`" alt="Logo">
                                </div>
                                <!--end::Avatar-->
